...
public function billingType(Request $request,$packageSlug)
{
     ...
     $address = [
          ...
          'country' => !empty($billing) ? $billing['country'] : 0,
          'state' => !empty($billing) ? $billing['state'] : 0,
          'city' => !empty($billing) ? $billing['city'] : 0,
          'latitude' => !empty($billing) ? $billing['latitude'] : 0,
          'longitude' => !empty($billing) ? $billing['longitude'] : 0,
     ];
