...
public function addArrayOfAttributesOfFields()
{
	return [
		'brands' => $this->brands,
		'colors' => $this->colors,
...
public function attributeField($attributes)
{

	if(!empty($attributes['attrbutes'])){
		$arr= '';
	    $attr = ' [attr]="[value]"';
		foreach ($attributes['attrbutes'] as $key => $value) {
...
{    
	 $attrbutes = $this->attributeField($arr);
