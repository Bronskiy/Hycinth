...
<div class="form-group">
   <div class="row">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control " id="staticEmail" name="sku" placeholder="SKU12345685">
    </div>
   </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-7">
      <div class="form-check">
		  <input class="form-check-input" type="checkbox" value="1" id="hasStock" name="hasStock">
...
<div class="form-group hasStock">
 <div class="row ">
    ...
    <div class="col-sm-7">
      <input type="number" min="0" class="form-control" name="lowInStock">
     </div>
  </div>
</div>
