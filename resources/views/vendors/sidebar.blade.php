            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                 ...
                 ? 'nav-item active' : 'nav-item' }}">
                        <a href="{{ route('vendor_category_assign2') }}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Add New Business</span></a>
                    </li>
    ...
    <a href="javascript:" class="nav-link "><span class="pcoded-micon">
        <i class="feather icon-box"></i></span><span class="pcoded-mtext">My Business</span></a>
