        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
               <h5>Drag & Drop List 
                        <small>Drag & Drop item arrange <b>Category</b></small></h5>
                                    ...
                                    <ol class="dd-list">
                                      @foreach($cate->subCategory as $sub)
                                       ...
                                       <li class="dd-item dd3-item   " data-id="<?= $sub->id ?>">
                                        ...
                                        <ul class="action-btn-wrap">
                                        <li><a href="{{url(route('edit_category',$sub->slug))}}" class="btn pull-right btn-primary action-btn"><i class="fas fa-pencil-alt"></i></a></li>
                                        <li><a href="{{url(route('delete_category',$sub->id))}}" class="btn pull-right btn-danger action-btn"><i class="fa fa-trash"></i></a></li>
                                          </ul>
                                          </div>
