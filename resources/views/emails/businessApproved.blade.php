...
<tr style="background-color: #fff;">
                  ...
                  <td>
                    ...
                    <tbody>
                      <tr>
                      <td style="font-family: 'Maven Pro', sans-serif; font-size: 24px; line-height: 1; color: #333; border-left: 2px solid #36496c; padding-left: 10px;">Business</td>
                    </tr>
                    </tbody>
                  </table>
                  </td>
                                ...
                                <tr>
                                  <td style="font-family: 'Maven Pro', sans-serif; font-size: 16px; line-height: 22px; color: #726c6c; padding-top: 10px;">Your Business has approved.</td>
                                </tr>
                <tr>
